...
# 乗合タクシー/エリアワゴン 10地区(市頁・利用ガイドPDFより)
WAGON = {
    ...
    "districts": ["頴田", "鯰田", "幸袋", "鎮西", "二瀬", "穂波",
                  "菰田", "飯塚東", "庄内", "筑穂"],
    # 予約乗合タクシー 予約センター(利用ガイドP5)
    "reserveTel": "0948-21-6600",
    "reserveHours": "予約受付: 平日 7:30〜16:30(利用日の1週間前〜1時間前まで)",
    "reserveNote": "初回のみ事前登録が必要(登録完了まで2〜4日)。",
}
